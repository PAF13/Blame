...
func (Liste *LAGERLISTE) writeStueckliste(name string) {
	...
	for _, b := range Liste.Betriebsmittel {
		...
		lineWriter(file2, "Sheet1", &colNum, &rowNum, "")
		lineWriter(file2, "Sheet1", &colNum, &rowNum, "")
		lineWriter(file2, "Sheet1", &colNum, &rowNum, b.Bestellnummer)
		lineWriter(file2, "Sheet1", &colNum, &rowNum, b.ERP)
		...
		lineWriter(file2, "Sheet1", &colNum, &rowNum, b.Quelle)
		lineWriter(file2, "Sheet1", &colNum, &rowNum, b.Beschreibung)
		rowNum++
